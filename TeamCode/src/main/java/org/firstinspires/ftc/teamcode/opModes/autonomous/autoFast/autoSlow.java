...
public class autoSlow extends LinearOpMode {
    ...
    // Trajectory Poses
    private final Pose path1Pose = new Pose(17, 218.497, Math.toRadians(0)); // Path 1
    private final Pose path2Pose = new Pose(84.5, 218.716, Math.toRadians(0)); // Path 2
    private final Pose path3Pose = new Pose(13.141, 149.14, Math.toRadians(180)); // Path 3
