...
@Autonomous
public class LeaveNearRed extends LinearOpMode {
    ...
    // Start Pose
    private final Pose startPose = new Pose(118.44947735191634, 127.9128919860627, Math.toRadians(-53)); // Start position

    // Trajectory Poses
    private final Pose launch0Pose = new Pose(123, 103.45644599303135, Math.toRadians(-90)); // Launch_0
