...
@Autonomous
public class LeaveNearBlue extends LinearOpMode {
    ...
    // Start Pose
    private final Pose startPose = new Pose(118.44947735191634, 127.9128919860627, Math.toRadians(-53)).mirror(); // Start position

    // Trajectory Poses
    private final Pose launch0Pose = new Pose(123.30662020905925, 103.45644599303135, Math.toRadians(-90)).mirror(); // Launch_0
    private final Pose prepArtifacts1Pose = new Pose(36,33.1010452961706, Math.toRadians(-90)).mirror(); // Prep_Artifacts_1
