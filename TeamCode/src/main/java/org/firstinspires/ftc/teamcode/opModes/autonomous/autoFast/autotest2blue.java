...
@Autonomous
public class autotest2blue extends LinearOpMode {
    ...
    // Trajectory Poses
    private final Pose path1Pose = new Pose(10, 202.228, Math.toRadians(270)); // Path 1
    ...
    private final Pose path5Pose = new Pose(18, 101.651, Math.toRadians(0)); // Path 5private final Pose path6Pose = new Pose(10.921, 130.566, Math.toRadians(280));
