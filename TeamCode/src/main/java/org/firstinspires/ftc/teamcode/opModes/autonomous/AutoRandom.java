...
public class AutoRandom extends LinearOpMode {
    ...
    private PathChain launch0Path, prepArtifacts1Path, intakeArtifacts1Path, launch1Path, prepArtifacts2Path, intakeArtifacts2Path, launch2Path, prepArtifacts3Path, intakeArtifacts3Path, launch3Path, prepArtifactsHpPath, intakeArtifactsHpPath, launchHpPath;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1:
                if (!follower.isBusy()) {
                    follower.followPath(prepArtifacts1Path);
                    setPathState(2);
                }
                break;
            ...
            case 2:
                if (!follower.isBusy()) {
                    follower.followPath(intakeArtifacts1Path);
                    setPathState(3);
                }
                break;
            ...
            case 3:
                if (!follower.isBusy()) {
                    follower.followPath(launch1Path);
                    setPathState(4);
                }
                break;
            ...
            case 4:
                if (!follower.isBusy()) {
                    follower.followPath(prepArtifacts2Path);
                    setPathState(5);
                }
                break;
            ...
            case 5:
                if (!follower.isBusy()) {
                    follower.followPath(intakeArtifacts2Path);
                    setPathState(6);
                }
                break;
            ...
            case 6:
                if (!follower.isBusy()) {
                    follower.followPath(launch2Path);
                    setPathState(7);
                }
                break;
            ...
            case 7:
                if (!follower.isBusy()) {
                    follower.followPath(prepArtifacts3Path);
                    setPathState(8);
                }
                break;
            ...
            case 8:
                if (!follower.isBusy()) {
                    follower.followPath(intakeArtifacts3Path);
                    setPathState(9);
                }
                break;
            ...
            case 9:
                if (!follower.isBusy()) {
                    follower.followPath(launch3Path);
                    setPathState(10);
                }
                break;
            ...
            case 10:
                if (!follower.isBusy()) {
                    follower.followPath(prepArtifactsHpPath);
                    setPathState(11);
                }
                break;
            ...
            case 11:
                if (!follower.isBusy()) {
                    follower.followPath(intakeArtifactsHpPath);
                    setPathState(12);
                }
                break;
            ...
            case 12:
                if (!follower.isBusy()) {
                    follower.followPath(launchHpPath);
                    setPathState(13);
                }
                break;
